class App.HomeController extends BeatLab.Controller
  ...
  load_tracks: ->
    ...
    @tracks = [
      ...
      track "morningbeat092115_3.mp3", "Morning Beat 9/21/15"
      track "morningbeat091715.mp3", "Morning Beat 9/17/15"
      track "morningbeat091015.mp3", "Morning Beat 9/10/15"
      track "morningbeat090415.mp3", "Morning Beat 9/04/15"
    ]
