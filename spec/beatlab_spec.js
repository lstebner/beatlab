...
(function() {
  var App, BeatLab, BeatsData, HUSH_LOG, Requires, Schema, _, __log, _str, beats, beats_data, beats_data_raw, data_keys_in_raw, expect, fs, num_beats_in_raw_data, num_collections_in_raw_data, process,
    slice = [].slice,
